# Quantum X — Experimental Micro Drone
...
**Top Speed:** 30Km/h (speed may vary from setup to setup) 
**Design Goal:** Reliable, lightweight, modular, and cleanly engineered

More flight data, logs, and refinements coming as the platform evolves.
